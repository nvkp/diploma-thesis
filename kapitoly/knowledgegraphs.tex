...
% Proto si tento způsob osvojili nejen komercní subjekty, které si od toho slibují ... ale i subjekty verejného sektoru, kteri disponují disponují takovými daty a bud jsou povinni, nebo poznaly uzitek v tom taková data publikovat pro verejnost

% odkazy na data.gov a data.gov.uk

\cite{gdpr162_2020}

% jedním zpusobem jak takova data publikovat je ve forme RDF
