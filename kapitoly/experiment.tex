...
% o datasetu jaur (job applicants and unemployment rate) => že to sou spolu dost korelující measures, že jsem na to musel myslet

% jaké to má dimenze, jaké hodnoty v dimenzích, jak jsem to nasekal

% kde v gitu jsou rezy, kde jsou dané notebooky (jenom footnoty)

% jaky pattern sem nastavil

% vyšší support diskriminuje kraje, takže supportem jsem neomezoval

% kolik to našlo pravidel, jak jsem si je profiltroval

% jak sem si je poshlukoval

% příklady pravidel, ukázat nějaké užitečné a ukázat nějaké vadné
